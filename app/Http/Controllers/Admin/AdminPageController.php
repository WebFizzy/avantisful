...
class AdminPageController extends Controller
{
    public function dashboard () {
        ...
        return view('admin.dashboard', compact(['title','blockedUsers', 'planCount', 'userNotAdminCount', 'totalDeposits', 'pendingDepositsCount', 'pendingDeposits', 'totalWithdrawal', 'pendingWithdrawals', 'pendingWithdrawalsCount', 'totalDepositsCount', 'totalWithdrawalCount']));
    }
