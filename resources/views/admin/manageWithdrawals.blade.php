                            ...
                            <tbody>
                                <tr>
                                    ...
                                    @if ($transaction->status == 'Pending')
                                        <td>
                                            <form id="approve_form" action="{{ route('approveWithdrawal', ['id' => $transaction->id]) }}" method="post">
                                                @csrf
                                                <input type="submit" value="Process" class="btn btn-success">
                                            </form>
                                        </td>
                                        <td>
                                            <form id="delete_form" action="{{ route('declineWithdrawal', ['id' => $transaction->id]) }}" method="post">
                                                @csrf
