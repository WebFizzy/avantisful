                            ...
                            <tbody>
                                <tr>
                                    ...
                                    @if ($transaction->status == 'Pending')
                                        <td>
                                            <form id="approve_form" action="{{ route('approveDeposit', ['id' => $transaction->id]) }}" method="post">
                                                @csrf
                                                <input type="submit" value="Process" class="btn btn-success">
                                            </form>
                                        </td>
                                        <td>
                                            <form id="delete_form" action="{{ route('declineDeposit', ['id' => $transaction->id]) }}" method="post">
                                                @csrf
