                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>${{ $user->getDeductableProfit() }}</td>
                                <td>${{ $user->getBonusBalance() }}</td>
                                        ...
                                        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body d-flex column">
                                                    <form id="delete_form" action="{{ route('user.update', ['user' => $user->id]) }}" method="post">
                                                        @csrf
                                                        @method('DELETE')
                                                    ...
                                                    <form id="lock_form" action="{{ route('adminLockUser', ['id' => $user->id]) }}" method="post">
                                                        @csrf
                                                        <input type="submit" value="Lock User" class="btn btn-danger">
                                                    </form>

                                                    <form id="unlock_form" action="{{ route('adminUnlockUser', ['id' => $user->id]) }}" method="post" >
                                                        @csrf
