                          ...
                          <td style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                            ...
                            <table class="ax-center" role="presentation" align="center" border="0" cellpadding="0" cellspacing="0" style="margin: 0 auto;">
                              <tbody>
                                <tr>
                                  <td style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                                    <img class="w-24" src="https://admin101.test/images/avantiswealth.png" style="height: auto; line-height: 100%; outline: none; text-decoration: none; display: block; width: 96px; border-style: none; border-width: 0;" width="96">
                                  </td>
                                </tr>
                              </tbody>
                            </table>
                            ...
                            <div class="text-muted text-center" style="color: #718096;" align="center">
                              Sent with &lt;3 from Trafalgar Terrace, <br>
                              Brighton and Hove. Brighten BN1 4DU,<br>
                              United Kingdom. <br>
                            </div>
                            <table class="s-6 w-full" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%">
                              <tbody>
