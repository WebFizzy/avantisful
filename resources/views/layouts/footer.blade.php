      ...
      <div class="container foot">
        <!-- <div class="footer-container"> -->
          ...
          <div class="footer">
            ...
            <p>Chat with our 24/7 support team on socials. Don't forget your fund is save wit us always
    ...
    <footer class="coppy">
      <div class="container copies">
        <!-- <div class="copyrights"> -->
          <div class="copyright">
            <small>2018 {{ env('APP_NAME') }}. &copy; All Rights Reserved.</small>
          </div>
          <!-- <div class="copyright">
            <span><a href="{{ url('about') }}">About Us</a></span>
            <span><a href="#btc">Markets</a></span>
            <span><a href="{{ url('plan') }}">Plans</a></span>
            <span><a href="{{ route('home') }}">Login</a></span>
          </div> -->
        <!-- </div> -->
      </div>
    </footer>
    ...
    <!-- <script src="//code.tidio.co/hvmynjlhmr5idyu5wxiyteab0ty26bkd.js" async></script> -->
